...
def dummy_user_add():
    user_data = [
        {"user_id": 1, "first_name": "원일", "last_name": "허", "age": 30},
        {"user_id": 2, "first_name": "범순", "last_name": "홍", "age": 28},
        {"user_id": 3, "first_name": "태현", "last_name": "김", "age": 26},
    ]
...
def dummy_recipe_add():
    recipe_data = [
        {"recipe_id": 1, "cook_time": 15, "description": "집에서 해먹는 일본식 라멘", 
        "process": "1) 팬에 오일을 살짝만 두르고 돼지고기 간 것과 간 생강을 넣고 볶는다. 2) 두반장, 미소, 설탕을 넣고, 물 1/4컵을 붓고 조린다. 3) 냄비에 참기름을 두르고 마늘, 생강 1/2t 을 볶는다. 4) 물 400ml, 치킨 부이용 1t, 미소 1T를 넣어 잘 풀어준다. 5)면을 2분 삶아 넣어준다. 6)옥수수, 대파, 아지츠케 타마고, 고기, 숙주를 토핑한다. ", 
        "cuisine_name": "일본식 라면"},
        {"recipe_id": 2, "cook_time": 7, "description": "백종원 7분 김치찌개", 
        "process": "1) 목살, 돼지고기, 파를 먹기 좋은 크기로 손질한다. 2) 돼지고기 목살을 한줌(150g) 넣어준다. 3) 물 또는 쌀뜨물 700ml를 냄비에 넣고 준비한 고기와 된장 1/2T를 넣고 끓인다. 4) 적당히 끓인후 김치 (2~3줌)와 다진마늘을 넣고 더 끓인다. 5)고추가루 1T, 국간장 1T를 넣는다. 6) 소금 또는 새우젓으로 간을 한후 대파를 넣는다. ",
        "cuisine_name": "김치찌개"},
        {"recipe_id": 3, "cook_time": 120, "description": "돼지갈비 황금레시피!!", 
        "process": "1) 돼지고기(1kg)의 핏물을 뺀 후 잔칼집을 내준다. 2) 간장5Ts, 설탕2Ts, 물엿1Ts, 간마늘1Ts, 참기름1Ts, 배1/4개, 사과1/4개, 매실청1Ts, 대파1뿌리, 물2컵, 깨소금1Ts 을 넣어 양념장을 만든다. 3) 고기를 양념장에 넣고 2시간 이상 재어준다. 4) 고기를 약한불에 굽는다. ",
        "cuisine_name": "돼지갈비"},
        {"recipe_id": 4, "cook_time": 10, "description": "누구나 좋아하는 치즈 계란찜!",
        "process": "1) 계란 3개를 깨서 뚝배기에 담는다. 2) 다진 당근 2T, 다진양파 2T, 맛소금 1티스푼, 물 종이컵 1컵, 피자치즈 1줌을 넣어 잘 섞은후 약한 불에 익혀준다. 3) 계란찜의 겉 테두리가 익고 기포가 올라오면 계란찜 위로 피자치즈를 1~2줌 넣어준다. 4) 조금 더 익히면 완성!", 
        "cuisine_name": "치즈계란찜"},
        {"recipe_id": 5, "cook_time": 10, "description": "10분이면 완성하는 중국식 볶음밥!",
        "process": "1) 햄, 양파, 대파, 당근 을 먹기 좋은 크기로 자른다. 2) 계란 2개를 풀어준다. 3) 웍에 기름은 두르고 햄을 넣고 볶는다. 4) 햄이 노릇해지면 대파를 넣고 볶은후 따로 담아둔다. 5) 웍에 계란을 두르고 휘저어 준다. 6) 계란 위에 밥을 올리고 잘 섞이도록 볶아준다. 7) 간장과 소금으로 간은 해준다. 8) 당근과 새우, 양파를 넣고 볶아준다. 9) 햄과 대파를 넣고 섞어준다. ", 
        "cuisine_name": "볶음밥"},
        {"recipe_id": 6, "cook_time": 10, "description": "대한민국 전동 비빔밥 만들기!",
        "process": "1)돼지고기, 양파, 당근, 애호박을 채썰어 준비한다. 2) 고추장 2T, 간장 2T, 설탕 1.5T, 소금 1T, 참기름 1T, 식초 1T 를 넣고 잘섞어 양념장을 만든다. 3) 당근, 애호박 순으로 소금을 한 꼬집씩 넣어 같이 볶아준다. 4) 양파는 간장으로 간을 하며 따로 볶아준다. 5) 돼지고기는 소금, 후추고 간을 하며 따로 볶아준다. 6) 익은 돼지고기를 양념장과 썩은후 밥위에 볶은 야채와 계란후라이와 함께 올려준다.", 
        "cuisine_name": "비빔밥"},
        {"recipe_id": 7, "cook_time": 5, "description": "바나나 우유 스무디!!",
        "process": "1) 바나나을 껍질을 벗긴 후 얇게 슬라이스하여 얼린다. 2) 1개 반 분량의 언 바나나를 꺼내어 우유 150ml와 함게 믹서기에 넣고 갈아준다. 3) 거품기로 휘핑을 해준다. ", 
        "cuisine_name": "스무디"},
        {"recipe_id": 8, "cook_time": 60, "description": "간단한 기본 케이크",
        "process": "1) 계란(4개) 흰자와 노른자를 분리한 후 계란 흰자에 설탕(120g)을 넣어주면서 머랭을 만들어준다. 2) 머랭에 노른자를 넣어 휘핑해준다. 3) 체친 밀가루(120g)를 넣고 올리브오(30g)일을 넣어 반죽을 골고루 섞어 준다. 4) 둥근틀에 유산지를 깔고 180도 오븐에 40분간 구워준다.", 
        "cuisine_name": "케이크"},
    ]
...
def dummy_refrigerator_stores_ingredient_add():
    refrigerator_stores_ingredient_data = [
        {"refrigerator": 1, "ingredient_name": "돼지고기"},
        {"refrigerator": 1, "ingredient_name": "면"},
        {"refrigerator": 1, "ingredient_name": "생강"},
        {"refrigerator": 1, "ingredient_name": "두반장"},
        {"refrigerator": 1, "ingredient_name": "마늘"},
        {"refrigerator": 1, "ingredient_name": "설탕"},
        {"refrigerator": 1, "ingredient_name": "미소"},
        {"refrigerator": 1, "ingredient_name": "김치"},
        {"refrigerator": 1, "ingredient_name": "대파"},
        {"refrigerator": 1, "ingredient_name": "된장"},
        {"refrigerator": 1, "ingredient_name": "고춧가루"},
        {"refrigerator": 1, "ingredient_name": "간장"},
        {"refrigerator": 1, "ingredient_name": "돼지갈비"},
        {"refrigerator": 1, "ingredient_name": "소금"},
        {"refrigerator": 1, "ingredient_name": "사과"},
        {"refrigerator": 1, "ingredient_name": "배"},

        {"refrigerator": 2, "ingredient_name": "계란"},
        {"refrigerator": 2, "ingredient_name": "피자치즈"},
        {"refrigerator": 2, "ingredient_name": "당근"},
        {"refrigerator": 2, "ingredient_name": "양파"},
        {"refrigerator": 2, "ingredient_name": "소금"},
        {"refrigerator": 2, "ingredient_name": "햄"},
        {"refrigerator": 2, "ingredient_name": "대파"},
        {"refrigerator": 2, "ingredient_name": "새우"},
        {"refrigerator": 2, "ingredient_name": "간장"},
        {"refrigerator": 2, "ingredient_name": "돼지고기"},
        {"refrigerator": 2, "ingredient_name": "애호박"},
        {"refrigerator": 2, "ingredient_name": "고추장"},
        {"refrigerator": 2, "ingredient_name": "간장"},
        {"refrigerator": 2, "ingredient_name": "설탕"},
        {"refrigerator": 2, "ingredient_name": "참기름"},


        {"refrigerator": 3, "ingredient_name": "바나나"},
        {"refrigerator": 3, "ingredient_name": "우유"},
        {"refrigerator": 3, "ingredient_name": "밀가루"},
        {"refrigerator": 3, "ingredient_name": "계란"},
        {"refrigerator": 3, "ingredient_name": "올리브오일"},
        {"refrigerator": 3, "ingredient_name": "설탕"},
    ]
